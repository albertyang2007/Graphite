		...
		httpServer
				.request(
						and(by(method("get")),
								...
								eq(query("format"), "json"))).response(
						with(pathResource("graphiteClientResponse.json")),
						header("Content-Type", MediaType.APPLICATION_JSON));

		/*
		 * httpServer.request(by(file(
		 * "src/main/resources/graphiteClientRequest.json"))).response(
		 * with(pathResource("graphiteClientResponse.json")));
		 */
