...
public class GraphiteJsonDataPointVODeserializer extends JsonDeserializer<List<GraphiteJsonDataPointVO>> {

    @Override
    public List<GraphiteJsonDataPointVO> deserialize(JsonParser jsonParser, DeserializationContext ctxt) {
